...
import com.lzc.crm.utils.Md5Util;
import com.lzc.crm.utils.PhoneUtil;
import com.lzc.crm.utils.UserIDBase64;
import com.lzc.crm.vo.UserRole;
import org.apache.commons.lang3.StringUtils;
import com.lzc.crm.base.BaseService;
import com.lzc.crm.dao.UserMapper;
...
public class UserService extends BaseService<User, Integer> {
    ...
    private void checkPasswordParams(User user, String oldPwd, String newPwd, String repeatPwd) {
        ...
        //判断确认密码是否为空
        AssertUtil.isTrue(StringUtils.isBlank(repeatPwd),"确认不能为空！");
        //判断确认密码是否与新密码一致
