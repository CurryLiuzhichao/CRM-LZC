package com.lzc.crm.aspect;

import com.lzc.crm.annoation.RequiredPermission;
import com.lzc.crm.exceptions.AuthException;
...
public class PermissionProxy {
    ...
    /**
     *  切面会拦截指定包下的指定注解
     *  拦截com.lzc.crm.annoation的RequiredPermission注解
     *
     * @param pjp
     * @return
     * @throws Throwable
     */
    @Around(value = "@annotation(com.lzc.crm.annoation.RequiredPermission)")
